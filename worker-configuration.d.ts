// Generated by Wrangler by running `wrangler types` (hash: 712619410b6f5e3087504a28eb6ab39f)
// Runtime types generated with workerd@1.20250319.0 2025-03-20 
declare namespace Cloudflare {
	interface Env {
		NUXT_PUBLIC_HOST: "https://preview.afonso.pages.dev" | "https://afonso.dev";
		NUXT_PUBLIC_NODE_ENV: string;
		CONTACT_FROM: string;
		CONTACT_TO: string;
		NUXT_PUBLIC_RECAPTCHA_SITE_KEY: string;
