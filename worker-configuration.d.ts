// Generated by Wrangler by running `wrangler types` (hash: 80bc04cc586582ad3bddadf52afb5d4c)
// Runtime types generated with workerd@1.20250730.0 2025-08-01
export {};
declare global {
  const NUXT_PUBLIC_NODE_ENV: 'development' | 'preview' | 'production';
  const NUXT_PUBLIC_HOST:
    | 'http://localhost:8787'
    | 'https://preview-afonso-dev.afonso.workers.dev'
    | 'https://afonso.dev';
